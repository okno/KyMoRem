...
if /I "%ARCH%"=="AMD64" (
  if exist "%~dp0KyMoRem-0.2.0-rc2-windows7-x64-client.exe" set "EXE=%~dp0KyMoRem-0.2.0-rc2-windows7-x64-client.exe"
)
if not defined EXE (
  if exist "%~dp0KyMoRem-0.2.0-rc2-windows7-x86-client.exe" set "EXE=%~dp0KyMoRem-0.2.0-rc2-windows7-x86-client.exe"
)
if not defined EXE (
